...
import { Settings, Search, Plus, Trash2, Building, BookOpen, LayoutList, Clock } from "lucide-react"
...
const entityConfigs: Record<string, { title: string; icon: React.ReactNode; endpoint: string; fields: EntityField[]; columns: string[]; renderRow: (item: any) => React.ReactNode[] }> = {
  sedes: {
  ...
  trayectos: {
    ...
    fields: [
      ...
      { name: 'pnfId', label: 'PNF ID', required: true },
    ],
